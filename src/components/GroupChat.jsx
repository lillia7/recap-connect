        ...
        <div className="Vertical-flex View-height">
            ...
            <div id="Chat-insert">
                <div id='Chat-text'>
                    ...
                    <Button onClick={() => handleSend(currChat)} className="Vertical-align" sx={{backgroundColor: '#EF6880', borderRadius: 50, height: '70px', width: '70px', marginLeft: '10px', marginTop: 'auto', marginBottom: 'auto'}}>
